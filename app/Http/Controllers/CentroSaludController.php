...
class CentroSaludController extends Controller
{
     ...
     public function centrosaludList()
    {
        ...
        SELECT centro_salud.id, centro_salud, cod_sicm, estado, municipio,direccion,tipo,contacto_tlf,contacto_email, 
    ...
    {
        $centro_salud = DB::select("SELECT centro_salud.id, cod_sicm, centro_salud, estado, municipio,direccion,tipo,contacto_tlf,contacto_email, 
        centro_salud.created_at, centro_salud.updated_at
        FROM centro_salud
        LEFT JOIN estados ON estado_id = estados.id
        LEFT JOIN municipios ON municipio_id = municipios.id
     ...
     public function store(Request $request)
    {
        ...
        $salud->codigo_sicm = $request->input('codigo_sicm');
